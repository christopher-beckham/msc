...
pdf("dist_abc_white.pdf", width=5, height=2)
par(mfrow=c(1,3))
barplot(dist1,names.arg=labels,las=2,col=cols,ylab="p(y|x)",main="distribution A",col.lab="white",col.axis="white",col.main="white",col.axis="white")
barplot(dist2,names.arg=labels,las=2,col=cols,ylab="p(y|x)",main="distribution B",col.lab="white",col.axis="white",col.main="white",col.axis="white")
barplot(dist3,names.arg=labels,las=2,col=cols, main="distribution C", col.lab="white",col.axis="white",col.main="white",col.axis="white")
dev.off()
