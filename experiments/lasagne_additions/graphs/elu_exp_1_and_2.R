...
df=read.csv(
  "/Users/cjb60/Desktop/lisa_tmp4_3/msc/experiments/lasagne_additions/output_stochastic_depth_resnet_new/long_baseline_more_augment_elu_lr0.1_leto18.0.txt"  
)

df3=read.csv(
  "/Users/cjb60/Desktop/lisa_tmp4_3/msc/experiments/lasagne_additions/output_stochastic_depth_resnet_new/long_nonlinearity_more_augment_elu_lr0.1.0.txt"  
)
